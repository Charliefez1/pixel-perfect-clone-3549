...
const projects = [
  {
    id: "1", title: "Barclays Leadership Programme", org: "Barclays", status: "Active",
    phase: 2, tasksComplete: 12, tasksTotal: 20, budget: 45000, invoiced: 22500,
    startDate: "2024-01-15", sessions: 8,
  },
  {
    id: "2", title: "Deloitte Wellbeing Series", org: "Deloitte", status: "Active",
    phase: 3, tasksComplete: 18, tasksTotal: 25, budget: 68000, invoiced: 51000,
    startDate: "2023-11-01", sessions: 12,
  },
  {
    id: "3", title: "NHS Yorkshire Resilience", org: "NHS Yorkshire", status: "Setup",
    phase: 0, tasksComplete: 2, tasksTotal: 15, budget: 35000, invoiced: 0,
    startDate: "2024-03-01", sessions: 0,
  },
  {
    id: "4", title: "AstraZeneca Team Performance", org: "AstraZeneca", status: "Active",
    phase: 1, tasksComplete: 6, tasksTotal: 18, budget: 52000, invoiced: 13000,
    startDate: "2024-02-10", sessions: 4,
  },
  {
    id: "5", title: "Google UK Neuro Workshop", org: "Google UK", status: "Completed",
    phase: 4, tasksComplete: 22, tasksTotal: 22, budget: 68000, invoiced: 68000,
    startDate: "2023-06-15", sessions: 16,
  },
];
