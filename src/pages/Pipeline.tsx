...
const stages = [
  { id: "lead", label: "New", color: "bg-[hsl(var(--stage-lead))]" },
...
export default function Pipeline() {
  return (
    <>
      ...
      >
        {/* View toggle like Bonsai */}
        <div className="flex items-center border border-border rounded-md overflow-hidden">
          <Button variant="ghost" size="icon" className="h-8 w-8 rounded-none bg-accent/50">
            ...
            return (
              <div key={stage.id} className="flex-shrink-0 w-64 flex flex-col">
                ...
                <div className="space-y-2 flex-1">
                  ...
                  <button className="w-full py-2 text-xs text-muted-foreground hover:text-foreground transition-colors border border-dashed border-border rounded-md hover:border-primary/30">
                    + New Deal
                  </button>
                </div>
              </div>
