...
export default function Meetings() {
  ...
  const renderSessionCard = (s: Session) => {
    ...
    const isWorkshop = (s as any).session_type === "workshop";
    ...
    <>
      ...
      <div className="flex-1 overflow-auto p-6">
        ...
        {isLoading ? (
          ...
          <div className="p-12 text-center text-muted-foreground">
            <p>No {typeFilter === "all" ? "sessions" : typeFilter === "meeting" ? "meetings" : "workshops"} found.</p>
          </div>
        ) : (
          <div className="space-y-4 max-w-4xl">
      ...
      {selected && (
        <DetailPanel
          ...
          fields={[
            { label: "Type", value: (selected as any).session_type === "workshop" ? "Workshop" : "Meeting" },
